...
testdata_decam stores large files using [git-lfs](https://git-lfs.github.com/). To use testdata_decam you must install git-lfs and configure it. LSST runs its own git-lfs server and storage service.
